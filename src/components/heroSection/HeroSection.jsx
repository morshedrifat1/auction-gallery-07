...
const HeroSection = () => {
  return (
    <div className="bg-[url(img/hero-banner.jpg)] bg-center bg-cover">
      <div className="max-w-[1536px] h-[730px] px-5 md:px-10 grid justify-start items-center ">
        <div className="space-y-5">
            <h1 className="text-white font-sora font-semibold text-5xl leading-[60px]">Bid on Unique Items from <br/>Around the World</h1>
